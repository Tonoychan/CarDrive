...
namespace Racing
{
    ...
    public class RaceOpponentPreset : ScriptableObject
    {
        ...
        [Tooltip("If false, the vehicle prefab's own engine values are used as-is.")]
        ...
        [Header("AI behaviour")]
        public VehicleAIPathFollower.TrafficPolicy trafficPolicy = VehicleAIPathFollower.TrafficPolicy.Racing;
